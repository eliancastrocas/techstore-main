...
# Importante: el dashboard principal /users/home/ debe ser accesible sin autenticación.
# Estas rutas se usan únicamente por los decoradores @login_required.
...
# Admin phone number for vendor verification
ADMIN_WHATSAPP = "+573125656485"

# DIAN API Configuration
DIAN_APP_TOKEN = "TU_DIAN_APP_TOKEN"  # Token de la DIAN
DIAN_API_TEST_MODE = True  # True = modo prueba (sin conexión real)
